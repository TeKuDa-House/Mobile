...
const SearchScreen = () => {
  ...
  const handleSearch = (text) => {
    // Vous pouvez implémenter ici la logique de recherche en utilisant le texte saisi dans 'text'.
    // Par exemple, effectuer une requête à votre API pour récupérer les résultats de recherche.
